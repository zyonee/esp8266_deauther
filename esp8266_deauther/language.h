...
const char SS_JSON_DEFAULT[] PROGMEM = "{\"random\":false,\"ssids\":[[\"99 problems, but WiFi ain't one\",true,31],[\"Abraham Linksys\",true,15],[\"Alexander Graham Belkin\",true,23],[\"All Your Bandwidth Belong to Us\",true,31],[\"Benjamin FranLAN\",true,16],[\"Bill Clinternet\",true,15],[\"Click Here for Viruses\",true,22],[\"Connected, Secured\",true,18],[\"Connecting…\",true,13],[\"Connection Lost\",true,15],[\"C:Virus.exe\",true,11],[\"Definitely Not Wifi\",true,19],[\"DHARMA Initiative – Station 4\",true,31],[\"Dora the Internet Explorer\",true,26],[\"Drop it like it’s Hotspot\",true,27],[\"Ermahgerd, Wi-Fi!\",true,17],[\"Free Public Wifi\",true,16],[\"Get off My LAN!\",true,15],[\"Help, I'm Trapped in This Router\",true,32],[\"I Can Haz Wireless?\",true,19],[\"I'm cheating on my WiFi\",true,23],[\"I'm Under Your Bed\",true,18],[\"I Pronounce you Man and WiFi\",true,28],[\"Iron LAN\",true,8],[\"It Burns When IP\",true,16],[\"It Hurts When IP\",true,16],[\"Jean Claude WAN Damme\",true,21],[\"John Wilkes Bluetooth\",true,21],[\"Keep it on the Download\",true,23],[\"LAN Down Under\",true,14],[\"LAN Halen\",true,9],[\"LAN Morrison\",true,12],[\"LAN of Milk and Honey\",true,21],[\"LAN Solo\",true,8],[\"Loading…\",true,10],[\"Look Ma, No Wires!\",true,18],[\"Ludwig WAN Beethoven\",true,20],[\"Network Not Found\",true,17],[\"No Internet Access\",true,18],[\"No More Mister Wifi\",true,19],[\"Not the Wifi You’re Looking Fo\",true,32],[\"Obi WAN Kenobi\",true,14],[\"Occam's Router\",true,14],[\"Password is 1234\",true,16],[\"Pretty Fly for a Wi-Fi\",true,22],[\"Searching…\",true,12],[\"Setting up…\",true,13],[\"Silence of the LANs\",true,19],[\"Skynet Global Defense Network\",true,29],[\"Spiderman’s World Wide Web\",true,28],[\"Tell My Wifi Love Her\",true,21],[\"TellYourWifiNeedMyPantsBack\",true,27],[\"The Internet\",true,12],[\"The LAN Before Time\",true,19],[\"The LAN of the Free\",true,19],[\"The Net starring Sandra Bullock\",true,31],[\"Theodore Routervelt\",true,19],[\"The Password Is 1234\",true,20],[\"The Promised LAN\",true,16],[\"The Wireless-G Spot\",true,19],[\"Trojan Virus\",true,12],[\"Untrusted Network\",true,17],[\"Very Slow\",true,9],[\"Virus Infected WiFi\",true,19],[\"Vladimir Computin\",true,17],[\"Wi believe I can Fi\",true,19],[\"WI-FIght the inevitable?\",true,24],[\"Wi-Fi, Wi-Not?\",true,14],[\"WiMCA\",true,5],[\"Winona Router\",true,13],[\"Wu-Tang LAN\",true,11],[\"Ye Olde Internet\",true,16]]}";
